...
namespace FrameLog
{
	...
	public:
		...
		FRAMELOG_API FileHandler(std::string_view Name, FileHandler::WriteType Write = WriteType::Write,
		...
		FRAMELOG_API bool SetFile(std::string_view Name, WriteType Writetype = WriteType::Write,
