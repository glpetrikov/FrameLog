...
namespace FrameLog {
    ...
    std::string_view Logger::GetLevelColor(LogLevel level) {
        switch(level) {
            case LogLevel::Trace: return Colors::IsColor(Colors::Color::Graphite);
            case LogLevel::Print: return Colors::IsColor(Colors::Color::BrightBlue);
            case LogLevel::Info:  return Colors::IsColor(Colors::Color::Green);
            case LogLevel::Warn:  return Colors::IsColor(Colors::Color::Yellow);
            case LogLevel::Error: return Colors::IsColor(Colors::Color::Red);
            case LogLevel::Fatal: return Colors::IsColor(Colors::BGColor::RedB);
            default: return "";
        }
    }

    std::string Logger::FormatPattern(const std::string& message,
                                     LogLevel level,
    ...
    int Logger::Trace(std::string Message) {
        if(IsPrinting(LogLevel::Trace, MinimalLevel)){
            ColorPrint(Message, LogLevel::Trace,
                      Colors::Color::Graphite, Colors::BGColor::Empty, false);
        }
        return 0;
    }
    ...
    int Logger::Print(std::string Message) {
        if(IsPrinting(LogLevel::Print, MinimalLevel)){
            ColorPrint(Message, LogLevel::Print,
                      Colors::Color::BrightBlue, Colors::BGColor::Empty, false);
        }
        return 0;
    }
    ...
    int Logger::Info(std::string Message) {
        if(IsPrinting(LogLevel::Info, MinimalLevel)){
            ColorPrint(Message, LogLevel::Info,
                      Colors::Color::Green, Colors::BGColor::Empty, false);
        }
        return 0;
    }
    ...
    int Logger::Warn(std::string Message) {
        if(IsPrinting(LogLevel::Warn, MinimalLevel)){
            ColorPrint(Message, LogLevel::Warn,
                      Colors::Color::Yellow, Colors::BGColor::Empty, false);
        }
        return 0;
    }
    ...
    int Logger::Error(std::string Message) {
        if(IsPrinting(LogLevel::Error, MinimalLevel)){
            ColorPrint(Message, LogLevel::Error,
                      Colors::Color::Red, Colors::BGColor::Empty, false);
        }
        return 0;
    }
    ...
    int Logger::Fatal(std::string Message) {
        if(IsPrinting(LogLevel::Fatal, MinimalLevel)){
            ColorPrint(Message, LogLevel::Fatal,
                      Colors::Color::Empty, Colors::BGColor::RedB, false);
        }
        return 0;
    }
    ...
    int Logger::TraceLine(std::string Message) {
        if(IsPrinting(LogLevel::Trace, MinimalLevel)){
            ColorPrint(Message, LogLevel::Trace,
                      Colors::Color::Graphite, Colors::BGColor::Empty, true);
        }
        return 0;
    }
    ...
    int Logger::PrintLine(std::string Message) {
        if(IsPrinting(LogLevel::Print, MinimalLevel)){
            ColorPrint(Message, LogLevel::Print,
                      Colors::Color::BrightBlue, Colors::BGColor::Empty, true);
        }
        return 0;
    }
    ...
    int Logger::InfoLine(std::string Message) {
        if(IsPrinting(LogLevel::Info, MinimalLevel)){
            ColorPrint(Message, LogLevel::Info,
                      Colors::Color::Green, Colors::BGColor::Empty, true);
        }
        return 0;
    }
    ...
    int Logger::WarnLine(std::string Message) {
        if(IsPrinting(LogLevel::Warn, MinimalLevel)){
            ColorPrint(Message, LogLevel::Warn,
                      Colors::Color::Yellow, Colors::BGColor::Empty, true);
        }
        return 0;
    }
    ...
    int Logger::ErrorLine(std::string Message) {
        if(IsPrinting(LogLevel::Error, MinimalLevel)){
            ColorPrint(Message, LogLevel::Error,
                      Colors::Color::Red, Colors::BGColor::Empty, true);
        }
        return 0;
    }
    ...
    int Logger::FatalLine(std::string Message) {
        if(IsPrinting(LogLevel::Fatal, MinimalLevel)){
            ColorPrint(Message, LogLevel::Fatal,
                      Colors::Color::Empty, Colors::BGColor::RedB, true);
        }
        return 0;
    }
    ...
    // ColorPrint
    //============================================================
    int Logger::ColorPrint(std::string Message, LogLevel level,
